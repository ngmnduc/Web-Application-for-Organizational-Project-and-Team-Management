...
export const mockKanbanTasks = [
    { id: 't1', title: 'Design new landing page wireframes for mobile responsive layout', status: 'Todo', priority: 'High', due: 'Dec 15', project: 'Website Redesign', assignee: 'SC' },
    { id: 't2', title: 'Research competitor pricing models', status: 'Todo', priority: 'Medium', due: 'Dec 18', project: 'Marketing Campaign', assignee: 'MJ' },
    { id: 't3', title: 'Set up analytics tracking', status: 'Todo', priority: 'Low', due: 'Dec 20', project: 'Website Redesign', assignee: 'AR' },
